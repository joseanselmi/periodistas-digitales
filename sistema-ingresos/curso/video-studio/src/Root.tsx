...
import { MockupIngresos, TOTAL_FRAMES_MK, FPS_MK } from "./MockupIngresos";

export const RemotionRoot: React.FC = () => {
  return (
    <>
      {/* Mockup animado: el medio -> los ingresos. 16:9, 1:1 y 9:16 salen del mismo componente. */}
      <Composition id="MockupIngresos" component={MockupIngresos} durationInFrames={TOTAL_FRAMES_MK} fps={FPS_MK} width={1920} height={1080} />
      <Composition id="MockupIngresos-1x1" component={MockupIngresos} durationInFrames={TOTAL_FRAMES_MK} fps={FPS_MK} width={1080} height={1080} />
      <Composition id="MockupIngresos-9x16" component={MockupIngresos} durationInFrames={TOTAL_FRAMES_MK} fps={FPS_MK} width={1080} height={1920} />
