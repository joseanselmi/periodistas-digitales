 ...
 *
 *   node herramientas/estado.mjs            # consulta todo y regenera ESTADO.md (~40 s)
 *   node herramientas/estado.mjs --rapido   # saltea la cola del embudo (el paso lento, ~30 s)
 *
...
// Este script vive en herramientas/; ESTADO.md y los archivos que lee están en
// la raíz del repo, un nivel arriba.
...
function armarMarkdown(d) {
  ...
  L.push('');
  L.push(`_Generado el ${AHORA.toISOString().slice(0, 16).replace('T', ' ')} UTC por \`node herramientas/estado.mjs\`. Si esta fecha no es de hoy, **volvé a correrlo antes de sacar conclusiones**._`);
  L.push('');
