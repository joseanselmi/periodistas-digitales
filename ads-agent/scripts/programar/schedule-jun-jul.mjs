...
const POSTS = [
  ...
  { folder: 'carousels/semana-22-06/para-subir/1-LUNES',     date: '2026-06-22', hour: 8, label: 'Lun 22/06 — Prompt 3 formatos' },
  { folder: 'carousels/semana-22-06/para-subir/2-MARTES',    date: '2026-06-23', hour: 8, label: 'Mar 23/06 — Recortes LATAM 2026' },
  { folder: 'carousels/semana-22-06/para-subir/3-MIERCOLES', date: '2026-06-24', hour: 8, label: 'Mié 24/06 — Elegir tu nicho' },
  { folder: 'carousels/semana-22-06/para-subir/4-JUEVES',    date: '2026-06-25', hour: 8, label: 'Jue 25/06 — Caso Marisol Beltrán' },
  { folder: 'carousels/semana-22-06/para-subir/5-VIERNES',   date: '2026-06-26', hour: 8, label: 'Vie 26/06 — Activo propio (venta)' },
  { folder: 'carousels/semana-22-06/para-subir/6-SABADO',    date: '2026-06-27', hour: 8, label: 'Sáb 27/06 — Identidad vs. circunstancia' },
  { folder: 'carousels/semana-22-06/para-subir/7-DOMINGO',   date: '2026-06-28', hour: 8, label: 'Dom 28/06 — IA en redacciones 2026' },

  // Semana 2 — "La IA no es el enemigo, es la ventaja" (29 jun - 5 jul)
  { folder: 'carousels/semana-29-06/para-subir/1-LUNES',     date: '2026-06-29', hour: 8, label: 'Lun 29/06 — Prompt research' },
  { folder: 'carousels/semana-29-06/para-subir/2-MARTES',    date: '2026-06-30', hour: 8, label: 'Mar 30/06 — El doble de notas, mismo sueldo' },
  { folder: 'carousels/semana-29-06/para-subir/3-MIERCOLES', date: '2026-07-01', hour: 8, label: 'Mié 1/07 — 3 herramientas de IA' },
  { folder: 'carousels/semana-29-06/para-subir/4-JUEVES',    date: '2026-07-02', hour: 8, label: 'Jue 2/07 — Caso Mariana Ibarra' },
  { folder: 'carousels/semana-29-06/para-subir/5-VIERNES',   date: '2026-07-03', hour: 8, label: 'Vie 3/07 — Módulo IA (venta)' },
  { folder: 'carousels/semana-29-06/para-subir/6-SABADO',    date: '2026-07-04', hour: 8, label: 'Sáb 4/07 — Miedo a quedar obsoleto' },
  { folder: 'carousels/semana-29-06/para-subir/7-DOMINGO',   date: '2026-07-05', hour: 8, label: 'Dom 5/07 — Cierres de medios LATAM' },

  // Semana 3 — "Así se ve el sistema funcionando de verdad" (6-12 jul)
  { folder: 'carousels/semana-06-07/para-subir/1-LUNES',     date: '2026-07-06', hour: 8, label: 'Lun 6/07 — Checklist primera edición' },
  { folder: 'carousels/semana-06-07/para-subir/2-MARTES',    date: '2026-07-07', hour: 8, label: 'Mar 7/07 — Parálisis por análisis' },
  { folder: 'carousels/semana-06-07/para-subir/3-MIERCOLES', date: '2026-07-08', hour: 8, label: 'Mié 8/07 — Script primer anunciante' },
  { folder: 'carousels/semana-06-07/para-subir/4-JUEVES',    date: '2026-07-09', hour: 8, label: 'Jue 9/07 — Caso Marcela Ibarra' },
  { folder: 'carousels/semana-06-07/para-subir/5-VIERNES',   date: '2026-07-10', hour: 8, label: 'Vie 10/07 — Mecanismo completo (venta)' },
  { folder: 'carousels/semana-06-07/para-subir/6-SABADO',    date: '2026-07-11', hour: 8, label: 'Sáb 11/07 — Primer paso imperfecto' },
  { folder: 'carousels/semana-06-07/para-subir/7-DOMINGO',   date: '2026-07-12', hour: 8, label: 'Dom 12/07 — Consumo de noticias LATAM' },

  // Semana 4 — "Tu periódico digital, mes 1: el plan completo" (13-19 jul)
  { folder: 'carousels/semana-13-07/para-subir/1-LUNES',     date: '2026-07-13', hour: 8, label: 'Lun 13/07 — Semana 1 del sistema' },
  { folder: 'carousels/semana-13-07/para-subir/2-MARTES',    date: '2026-07-14', hour: 8, label: 'Mar 14/07 — Proyección a 1 año' },
  { folder: 'carousels/semana-13-07/para-subir/3-MIERCOLES', date: '2026-07-15', hour: 8, label: 'Mié 15/07 — WhatsApp/Telegram' },
  { folder: 'carousels/semana-13-07/para-subir/4-JUEVES',    date: '2026-07-16', hour: 8, label: 'Jue 16/07 — Caso Valeria Suárez' },
  { folder: 'carousels/semana-13-07/para-subir/5-VIERNES',   date: '2026-07-17', hour: 8, label: 'Vie 17/07 — Mecanismo 4 semanas (venta)' },
  { folder: 'carousels/semana-13-07/para-subir/6-SABADO',    date: '2026-07-18', hour: 8, label: 'Sáb 18/07 — Sin renunciar' },
  { folder: 'carousels/semana-13-07/para-subir/7-DOMINGO',   date: '2026-07-19', hour: 8, label: 'Dom 19/07 — Medios independientes LATAM' },

  // Semana 5 — "Las objeciones reales, respondidas" (20-26 jul)
  { folder: 'carousels/semana-20-07/para-subir/1-LUNES',     date: '2026-07-20', hour: 8, label: 'Lun 20/07 — Prompt calendario contenido' },
  { folder: 'carousels/semana-20-07/para-subir/2-MARTES',    date: '2026-07-21', hour: 8, label: 'Mar 21/07 — Objeción "no tengo tiempo"' },
  { folder: 'carousels/semana-20-07/para-subir/3-MIERCOLES', date: '2026-07-22', hour: 8, label: 'Mié 22/07 — No hace falta ser técnico' },
