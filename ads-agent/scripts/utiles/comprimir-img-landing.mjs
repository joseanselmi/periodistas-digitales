 ...
 * Uso: node scripts/utiles/comprimir-img-landing.mjs
 */
import sharp from 'sharp'
import { statSync } from 'fs'
import { join } from 'path'

const IMGDIR = join('..', 'sistema-ingresos', 'paginas', 'img', 'originales')
...
// El .png fuente vive en img/originales/ y el .webp servido en img/landing/:
// son carpetas distintas a propósito, así no se sirve por error el original pesado.
