 ...
 *
 * Uso: node scripts/generar/gen-muro-stories.mjs   →   node scripts/exportar/export-stories.mjs
 * Publicar: node --env-file=.env.local scripts/publicar/post-story.mjs [YYYY-MM-DD]
 *
...
console.log('Siguiente: node scripts/exportar/export-stories.mjs')
