 ...
 * Uso: node scripts/generar/carousel-generator.mjs
...
3) Las 5 preguntas clave que no pueden faltar"
      ...
      },
      {
        ...
        html: `
          ...
          <div class="cta">Ver el sistema completo · $10 USD</div>
        `
      },
    ]
  },
    ...
    generateSlides: async () => [
      ...
      },
      {
        ...
        html: `
          ...
          <div class="cta" style="margin-top:8px">Link en bio · $10 USD</div>
        `
      },
    ]
  },
    ...
    generateSlides: async () => [
      ...
      },
      {
        ...
        html: `
          ...
          <p class="body small" style="margin-top:0;color:#64748b">Por $10 USD podés ser el próximo. <strong>Link en bio.</strong></p>
        `
      },
    ]
  },
    ...
    generateSlides: async () => [
      ...
      },
      {
        ...
        html: `
          ...
          <h2 class="headline medium">El mismo sistema<br>que está disponible<br>por <span class="accent">$10 USD.</span></h2>
    ...
    generateSlides: async () => [
      ...
      },
      {
        ...
        html: `
          ...
          <p class="body small" style="color:#94a3b8">Sistema de Ingresos Diarios para Periodistas · <strong>$10 USD · Link en bio</strong></p>
        `
      },
    ]
  },
