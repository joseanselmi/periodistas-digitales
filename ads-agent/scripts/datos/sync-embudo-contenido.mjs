...
const DESDE_MAKE = [
  {
    ...
    text: 'Tu guía ya está lista. Descargala acá: https://sistemadeingresosdiariosia.com/api/d?file=guia-claude-periodistas.pdf&src=Email-Regalo1&sck=email1',
