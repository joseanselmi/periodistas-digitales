 ...
 *
 * Uso:
 *   node scripts/datos/parse-compradores.mjs archivo1.csv archivo2.csv ...
 *
...
if (!archivos.length) {
  console.error('❌ Uso: node scripts/datos/parse-compradores.mjs archivo1.csv archivo2.csv ...')
  process.exit(1)
}
