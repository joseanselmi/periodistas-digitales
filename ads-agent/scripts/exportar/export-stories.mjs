 ...
 * Uso: node scripts/exportar/export-stories.mjs [carpeta]   (default: carousels/muro-stories)
 */
...
await browser.close()
console.log(`\n✅ Listo. Publicar con: node --env-file=.env.local scripts/publicar/post-story.mjs [YYYY-MM-DD]`)
